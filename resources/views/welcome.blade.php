...
<head>
    ...
    <title>EwnetNews - Stay Informed</title>
...
<body class="bg-slate-600 font-sans antialiased">
    <!-- Animated Header -->
    <header class="bg-slate-200 sticky top-0 z-50 animate__animated animate__fadeInDown">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <a href="/" class="flex items-center space-x-2">
                <span class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-indigo-300 bg-clip-text text-transparent">EwnetNews</span>
            </a>
            <nav class="hidden md:flex space-x-8">
                <a href="#features" class="text-gray-700 hover:text-yellow-600 transition-colors font-medium">Features</a>
                <a href="#categories" class="text-gray-700 hover:text-yellow-600 transition-colors font-medium">Categories</a>
                <a href="#trending" class="text-gray-700 hover:text-yellow-600 transition-colors font-medium">Trending</a>
            </nav>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-4">Why Choose EwnetNews?</h2>
    ...
    <section id="trending" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="news-card bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <a href="#" class="text-yellow-600 font-medium hover:underline">Read More →</a>
                    </div>
                </div>
            ...
            <div class="text-center mt-12">
                <a href="#" class="inline-block px-8 py-3 bg-yellow-600 text-white font-bold rounded-lg hover:bg-yellow-700 transition-colors shadow-lg">View All Trending News</a>
            </div>
        </div>
    </section>
